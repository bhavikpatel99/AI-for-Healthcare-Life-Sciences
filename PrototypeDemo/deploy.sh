...
python -c "import zipfile; z=zipfile.ZipFile('process_document.zip','w',zipfile.ZIP_DEFLATED); z.write('process_document.py'); z.close(); print('  process_document.zip created')"
...
python -c "import zipfile; z=zipfile.ZipFile('approve_document.zip','w',zipfile.ZIP_DEFLATED); z.write('approve_document.py'); z.close(); print('  approve_document.zip created')"
aws lambda create-function \
